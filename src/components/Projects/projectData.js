const projectData = [
  {
    ...
    name: "Project 1",
    description:
      "We have worked together to combine two external API's to generate this page. We used a gender guesser and of course, Chuck Norris! Get the API to guess your gender by your name, while also getting a classic Chuck Norris joke!",
    githubLink: "https://github.com/DanielOrnelas01/project-1",
    liveAppLink: "https://danielornelas01.github.io/project-1/",
    imgAlt: "Project 1",
    photoUrl: process.env.PUBLIC_URL + '/project/small/portfolio-1-sm.jpg',
  },
  {
    id: 2,
    name: "Project 2",
    ...
    imgAlt: "Project 2",
    photoUrl: process.env.PUBLIC_URL + '/project/small/portfolio-2-sm.jpg',
  },
  {
    id: 3,
    name: "Budget Tracker",
  ...
  },
  {
    ...
    photoUrl: process.env.PUBLIC_URL + '/project/small/social-network-sm.jpg',
  },
];
